...
def main():
    ...
    if concept_flow.get("available"):
        ...
        tf = concept_flow.get("target_flow", {})
        if tf:
            print(f"  能建排名: {concept_flow.get('target_rank',0)}/{concept_flow.get('target_rank_total',0)} | "
