...
| 有色金属 | `./有色金属/` | 黄金铜矿、小金属供需分析、**大宗商品期货追踪** |
| 新能源 | `./新能源/` | 光伏、储能、锂电 |
| 商业航天 | `./商业航天/` | 产业链扫描、全球竞争格局、元器件国产化 |
| 通信 | `./通信/` | 产业链深度调研 |
| 宏观经济 | `./宏观经济/` | 周期跟踪、政策解读、产业革命研判 |
| 金融 | `./金融/` | 保险、银行、券商 |
...
| 目录 | 路径 | 说明 |
|------|------|------|
| 政策消息跟踪 | [`./政策事件追踪/`](./政策事件追踪/) | 定期扫描政策/事件/权威消息，按重要性排序并分析对 A 股行业和个股的传导影响 |
...
| 大宗商品追踪 | [`./有色金属/`](./有色金属/) | 全球大宗商品期货价格追踪——26个国际+国内品种，价格仪表盘+供需分析+政策事件+A股映射（由 commodity-futures-tracker skill 驱动） |
